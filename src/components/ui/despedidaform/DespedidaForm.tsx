...
export const DespedidaForm = () => {
  ...
  return (
    <div className="bg-gray-200 p-4 rounded shadow mb-4">
        <h2 className="text-xl font-bold mb-4">Subir Clip de Despedida</h2>
    <form onSubmit={handleSubmit} encType="multipart/form-data">
      <label>
        <input type="file" accept="audio/*" onChange={handleFileChange} />
      </label>
      <button type="submit" className="px-4 py-2 bg-green-500 text-white rounded-full">Subir Despedida</button>
    </form>
    </div>
